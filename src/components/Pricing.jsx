...
const Header = () => <header className="relative text-center mb-12 md:mb-20 px-4 z-10">
    ...
    <h1 className="text-4xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white leading-tight tracking-tighter animate-fade-in-down">
        Pricing made for <br />
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">teams of all sizes</span>
    </h1>

    <p className="text-gray-600 dark:text-gray-300 mt-6 text-base sm:text-base max-w-2xl mx-auto animate-fade-in-down" style={{
        animationDelay: '0.4s'
    }}>
      ...
      `}</style>
        <div className="relative font-sans flex flex-col items-center justify-center overflow-x-hidden bg-white dark:bg-black min-h-screen">
            <div className="container mx-auto px-4 py-16 md:py-24">
                <Header />
                <main className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10 items-stretch max-w-7xl mx-auto">
